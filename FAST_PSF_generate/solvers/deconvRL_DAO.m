...
function recon = deconvRL_DAO(forwardFUN, backwardFUN, img, iter, init, H, Ht,img_name,save_Path,DAO,Nb,img_idx)
...
for i = 1:iter
    ...
    if mod(i,5)==0 && i~=0
        recon = gather(recon);
        str_save=fullfile(save_Path,sprintf('Deconv_img%d_iter%d.tif',img_idx,i));
