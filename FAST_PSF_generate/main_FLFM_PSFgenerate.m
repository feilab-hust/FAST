...
Config.n = 1;
Config.SensorSize = [1499,1499]; %the size of the input light field image,1075
Config.X_center = ceil(Config.SensorSize(1)/2);
Config.Y_center = ceil(Config.SensorSize(2)/2);
Config.depthStep = 0.1;
Config.depthRange = [-8,8];
...
%theta_dof= Config.lensPitch*sqrt(2)/Config.f2;
theta_dof= Config.lensPitch/Config.f2;
%theta_dof= Config.lensPitch*2/Config.f2;
...
% rz=Config.WaveLength/(sqrt(2))*(Config.f2/Config.lensPitch*Config.fobj/Config.f1)^2;
