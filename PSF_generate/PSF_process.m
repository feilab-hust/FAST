...
%% PSF Processing
large_PSF=imread3d('.\PSF_example\PSF_[60 1.5 z-5-5 0.1um].tif');
...
for idx=1:length(coordiy)
    ...
    write3d(PSF_crop,sprintf('./PSF_example/crop/psf_raw_view%d.tif',idx),32);
    ...
    write3d(center_PSF,sprintf('./PSF_example/center_shift/psf_center_view%d.tif',idx),32);
    ...
    write3d(FAST_PSF,sprintf('./PSF_example/FAST_PSF/PSF_FAST_view%d.tif',idx),32);
...
save('./PSF_example/crop/H_raw_[60 1.5 -5-5 0.1].mat','H_raw','-v7.3');  
save('./PSF_example/crop/Ht_raw_[60 1.5 -5-5 0.1].mat','Ht_raw','-v7.3');
save('./PSF_example/FAST_PSF/H_fast_[60 1.5 -5-5 0.1].mat','H_FAST','-v7.3');  
save('./PSF_example/FAST_PSF/Ht_fast_[60 1.5 -5-5 0.1].mat','Ht_FAST','-v7.3');
