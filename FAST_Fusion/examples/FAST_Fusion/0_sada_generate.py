...
PEAK=100000
#path = r'I:\Code\Care_FLFM\examples\FLFM\PSF\PSF(view7_DOE_m5-5)\view_stack_shift'
...
for name in os.listdir(img_path):
 ...
 for file in os.listdir(path):
    ...
    for i in range(PSF.shape[0]):
     ...
     #img_conv = img/np.amax(img)
     index1 = 1 /25000 * np.random.uniform(5, 20)
     index2 = PEAK
     SBR = 1
     img_conv = gasuss_noise(img_conv,index1,SBR=SBR)
     #img_conv = gasuss_possion_noise(img_conv,index1,index2,SBR)
